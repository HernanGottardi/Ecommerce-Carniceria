namespace formularios
{
    partial class FrmQuitarCorte
    {
        ...
        private void InitializeComponent()
        {
            ...
            lsb_listaDeCortes.ItemHeight = 20;
            lsb_listaDeCortes.Location = new Point(140, 123);
            lsb_listaDeCortes.Name = "lsb_listaDeCortes";
            lsb_listaDeCortes.Size = new Size(458, 164);
            lsb_listaDeCortes.TabIndex = 2;
            // 
            // lb_tituloQuitarCorte
            // 
            lb_tituloQuitarCorte.AutoSize = true;
            lb_tituloQuitarCorte.Font = new Font("Segoe UI", 15F, FontStyle.Regular, GraphicsUnit.Point);
            lb_tituloQuitarCorte.Location = new Point(140, 57);
            lb_tituloQuitarCorte.Name = "lb_tituloQuitarCorte";
            lb_tituloQuitarCorte.Size = new Size(341, 35);
